...
### 3. [Differentiable Structural EM for Explicit-Latent Linear-Gaussian DAGs](https://openreview.net/pdf?id=h28Uy8h4us) (my talk!)
*Mohammad Ali Javidian, R. Mitchell Parry*

📄 [Read the paper (OpenReview PDF) →](https://openreview.net/pdf?id=h28Uy8h4us)
